...
namespace gerenciador.financas.Infra.Vendors.Repositories
{
    ...
    {
        public Task<List<DespesaResponseInfra?>> GetDespesasPorUsuario(int idUsuario, int periodo);
        ...
        public Task<bool> InsertDespesa(CadastrarDespesaRequestInfra despesaRequest, int idUsuario, int? idCategoria, int idMetodoPagamento);
        public Task<bool> UpdateDespesa(AtualizarDespesaRequestInfra despesaRequest, int idUsuario, int idDespesa, int? idCategoria, int idMetodoPagamento);
